...
def stream_processor():
    ...
    def print_stream():
        ...
        global total_events, high_level, treasure_found, level_up

        print(f"Processing {len(events)} game events...\n")

        for event in stream_data():
            print(
                f"Event {total_events + 1}: "
...
def stream_analytics():
    ...
    print(f"Treasure events: {treasure_found}")
...
def demo_generators():
    ...
    for i in range(5):
        print(next(prime_gen), end=", " if i < 4 else "\n")
